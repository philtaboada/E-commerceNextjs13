...
const ItemContent: React.FC<ItemContentProps> = ({ item }) => {
    ...
    return (<div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px] border-slate-300 items-center">
        <div className="col-span-2 justify-self-start flex gap-2 md:gap-4 my-2">
